...
part 'update_importer_stundenplan24_request.g.dart';

@JsonSerializable()
class UpdateImporterStundenplan24Request {
  const UpdateImporterStundenplan24Request({
    required this.name,
  ...
  factory UpdateImporterStundenplan24Request.fromJson(Map<String, Object?> json) => _$UpdateImporterStundenplan24RequestFromJson(json);
  ...
  Map<String, Object?> toJson() => _$UpdateImporterStundenplan24RequestToJson(this);
}
