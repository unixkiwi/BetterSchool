...
part 'store_announcement_request.g.dart';

@JsonSerializable()
class StoreAnnouncementRequest {
  const StoreAnnouncementRequest({
    required this.title,
    required this.from,
    required this.to,
  ...
  factory StoreAnnouncementRequest.fromJson(Map<String, Object?> json) => _$StoreAnnouncementRequestFromJson(json);
  ...
  Map<String, Object?> toJson() => _$StoreAnnouncementRequestToJson(this);
}
